...
<div class="d-flex flex-row-reverse mybgColor">
  ...
  <div class="p-2 bg-primary">
  <a href="${pageContext.request.contextPath}/member/memberForm" class="nav-link text-white" id="item3">MyPage</a></div>
  </c:when>
  </c:choose>
</div>
        <!-- Carousel -->
    ...
    <nav class="navbar navbar-expand-sm mybgColor" >
     <div class="container-fluid" >
        <ul class="navbar-nav" >
            ...
            <li class="nav-item"><a href="${pageContext.request.contextPath}/upload/upboardList?cPage=1" class="nav-link">Upload</a></li>
