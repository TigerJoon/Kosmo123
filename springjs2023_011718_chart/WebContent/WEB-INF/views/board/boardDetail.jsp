...
<!-- pattern 속성을 이용한 정규표현식으로 데이터의 유효성 검사를 할 수 있다. -->
      <input type="text" class="form-control" id=subject value="${vo.subject }" readonly="readonly">
    </div>
    <div class="form-group">
...
<!--  textarea 안에 있는 모든 글자는 그대로 나타난다. 공백문자, tag, enter -->
   <textarea class="form-control" rows="5" id="contents"
    name="contents" readonly="readonly">${vo.contents }</textarea>
   </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="reip" name="reip" value="${vo.reip }" readonly="readonly">
    </div>  
